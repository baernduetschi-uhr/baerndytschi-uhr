...
export default function HolidaysPage() {
  ...
  // Übersetzungen laden wenn Feiertag gewechselt
  useEffect(() => {
    ...
    async function loadTranslations() {
      ...
      // Für alle aktiven Sprachen — falls keine Übersetzung vorhanden → leer
      setTranslations(
        languages.map((l) => ({
          language: l.code,
  ...
  function setTranslationValue(language: string, value: string) {
    setTranslations((prev) =>
      prev.map((t) => (t.language === language ? { ...t, value } : t))
    );
  }
    ...
    <div className="text-white">
      <div className="mb-8">
        ...
        <p className="mt-3 text-zinc-400">
          Änderige wärde direkt i Supabase gspeicheret.
        </p>
      </div>
        ...
        <div className="grid grid-cols-1 gap-6 xl:grid-cols-[360px_minmax(0,1fr)]">
          ...
          <section className="rounded-[2rem] border border-zinc-800 bg-zinc-950 p-5">
            ...
            <div className="space-y-4">
              ...
              {items.length === 0 && (
                <div className="text-zinc-500">No kei Feiertäg vorhanden.</div>
              )}
            </div>
          </section>

          {/* Rechte Bearbeitungsseite */}
              ...
              <>
                  ...
                  <label className="block">
                    ...
                    <input
                      ...
                      onChange={(e) => {
                        ...
                        // Key automatisch generieren wenn noch kein manueller Key
                        const autoKey = nameToKey(newName);
                        setDraft({
                          ...draft,
                          name: newName,
                          key: draft.key ?? autoKey,
                        });
                      }}
                ...
                <div className="mt-8">
                  ...
                  <p className="text-sm text-zinc-500 mb-5">
                    Text der pro Sprache auf der Uhr erscheint wenn dieser Feiertag aktiv ist.
                  </p>
                ...
                {saved && (
                  <div className="mt-4 text-green-400">✓ gspeicheret</div>
                )}
